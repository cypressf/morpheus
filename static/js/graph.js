...
(function() {
  var InteractionState, Sleep, TempBar, User, chartC, chartO, createUserBar, csrfSafeMethod, currentInteractionState, dateFromX, formatTime, getCookie, globalChartCOffset, mainUser, overviewState, position, randint, refreshUserBar, resizeChart, resizeLines, ticks, timeFromY, updateCurrent, updateOverview, xPosition;
  ...
  updateCurrent = function() {
    ...
    return resizeChart(chartC, '#current-chart', currentInteractionState, 10);
  };
  ...
  resizeChart = function(chart, idStr, state, spacing) {
    var dmax, dmin, elementCount, h, tw, w;
    if (spacing == null) {
      spacing = 1;
    }
  ...
  window.morpheus.getDataForUser((function(response) {
    ...
    overviewState.setRange(mainUser.sleeps[0].start, mainUser.sleeps.slice(-1)[0].end);
