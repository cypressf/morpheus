...
(function() {
  var InteractionState, Sleep, TempBar, User, chartC, chartO, csrfSafeMethod, currentInteractionState, dateFromX, formatTime, getCookie, globalChartCOffset, mainUser, position, randint, resizeChart, resizeLines, temp, ticks, timeFromY, updateCurrent, updateOverview, updateUserBar, xPosition;
  ...
  updateUserBar = function() {
    return chartC.selectAll(".userbar").data(currentInteractionState.currentBar).enter().append("rect").attr("class", "userbar").attr("x", function(d) {
      return d.x;
    }).attr("y", function(d) {
      return d.y;
